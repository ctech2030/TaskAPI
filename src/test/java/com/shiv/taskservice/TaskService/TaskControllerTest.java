...
class TaskControllerTest {
	...
	void getTasks() {
		...
		List<Task> mockedTasks = List.of(new Task(1L, "Task 1", "Description 1", "pending", "high", null, null),
		...
		verify(taskService, times(1)).getAllTasks(PageRequest.of(0, 10, Sort.by("priority")));
